<div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href=""><img src="" alt="Fashion" /></a>
          <a class="sidebar-brand brand-logo-mini" href=""><img src="" alt="Fashion" /></a>
        </div>
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('displayproduct')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('displayuser')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{url('showorders')}}">
              ...
              <span class="menu-title">Display orders</span>
            </a>
          </li>
